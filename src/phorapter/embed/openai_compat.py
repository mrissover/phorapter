...
else fails fast as :class:`~phorapter.errors.EmbedderError`.
"""
...
try:
    ...
    raise ImportError('OpenAICompatEmbedder requires httpx: pip install "phorapter[server]"') from e
...
class OpenAICompatEmbedder(Embedder):
    """:class:`~phorapter.embed.Embedder` over any OpenAI-compatible embeddings endpoint.

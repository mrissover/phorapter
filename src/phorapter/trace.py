...
(:meth:`phorapter.model.SliceRef.uuid` without a corpus qualifier); traces are
...
the :class:`~phorapter.selection.SliceSource` (the prefetched ancestor closure)."""
...
class ForestTrace:
    ...
    hit_count: int
    """Distinct hits (by :class:`~phorapter.model.SliceRef`) in the forest."""
    edge_count: int

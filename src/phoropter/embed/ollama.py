...
try:
    ...
    raise ImportError('OllamaEmbedder requires httpx: pip install "phoropter[server]"') from e
...
class OllamaEmbedder(Embedder):
    """:class:`~phoropter.embed.Embedder` over a local or remote Ollama server.

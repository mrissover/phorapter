...
from phoropter.model import CandidateHit, HitProvenance, RetrievedHit, Slice, SliceRef
from phoropter.tokens import DEFAULT_COUNTER_ID, get_counter
from phoropter.trace import (
    DedupEntry,
    FinalTrace,
    ForestTrace,
    FusionTrace,

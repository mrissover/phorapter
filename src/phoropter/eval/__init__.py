...
running server and aggregating query traces. See :mod:`phoropter.eval.harness`
for the metrics and ``phoropter eval --help`` for the CLI.
"""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="phoropter eval", description="Offline evaluation harness"
    )
...
def main(argv: Sequence[str] | None = None) -> int:
    """CLI entry point for ``phoropter eval``."""
